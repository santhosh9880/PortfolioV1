    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white overflow-x-hidden">
      <header className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/30 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-400">DevOps & Cloud Engineer</p>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-emerald-500/10 border border-emerald-400/20 rounded-full px-5 py-2 mb-8">
              ...
              <span className="text-emerald-300 text-sm">Available for DevOps Roles</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mt-16">
              {stats.map(([num, label]) => (
                ...
                >
                  <div className="text-3xl font-black text-emerald-400">{num}</div>
          ...
          >
            ...
            <div className="w-full max-w-xl bg-slate-950 border border-white/10 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl">
              <div className="flex items-center gap-2 px-6 py-4 border-b border-white/10 bg-black/40">
                ...
                <span className="ml-4 text-sm text-slate-400 font-mono">santhosh@devops:~</span>
              </div>
              ...
              <div className="p-8 font-mono text-sm leading-8">
                ...
                <p className="text-slate-400">microservices-app Running</p>
                <p className="text-slate-400">terraform-stack Running</p>
                <p className="text-slate-400">ci-cd-pipeline Running</p>
                ...
                <p className="text-cyan-400">Infrastructure provisioned successfully ✓</p>
                ...
                <p className="text-slate-400">5 containers healthy</p>

                <br />

                <p>
                  <span className="text-emerald-400">$</span> deployment-status
                </p>
                <p className="text-emerald-300">✔ Zero downtime achieved</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-emerald-400 uppercase tracking-[0.3em] text-sm mb-4">About Me</p>
            <h2 className="text-5xl font-black mb-8">Professional DevOps Engineer</h2>
      ...
      <section id="projects" className="px-6 py-24 bg-black/20 border-y border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-emerald-400 uppercase tracking-[0.3em] text-sm mb-4">Featured Projects</p>
            <h2 className="text-5xl font-black">Production Grade Infrastructure</h2>
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="text-6xl font-black text-white/5 mb-6">0{index + 1}</div>
                  <h3 className="text-3xl font-bold mb-5">{project.title}</h3>
                  <p className="text-slate-300 leading-8 text-lg">{project.desc}</p>
      ...
      <section id="experience" className="max-w-7xl mx-auto px-6 py-24">
        <div className="mb-16">
          <p className="text-emerald-400 uppercase tracking-[0.3em] text-sm mb-4">Experience</p>
          <h2 className="text-5xl font-black">Internship & Professional Work</h2>
        </div>
        <div className="bg-white/5 border border-white/10 rounded-3xl p-10 backdrop-blur-xl hover:border-emerald-400/30 transition-all">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
            <div>
              <h3 className="text-3xl font-bold">DevOps Engineer Intern</h3>
              <p className="text-emerald-400 mt-2">DSEdify · Bengaluru</p>
            </div>
      ...
      <section id="contact" className="px-6 py-24 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border-t border-white/10">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-black leading-tight">
            Let's Build
            <span className="block text-emerald-400">Cloud Systems Together</span>
          </h2>
